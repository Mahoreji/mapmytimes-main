...
/// Complete theme — Neo-brutalist MapMyTimes look
class MmtTheme {
  MmtTheme._();
  ...
  static ThemeData _base(Brightness mode) {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        centerTitle: false,
        titleTextStyle: MmtText.h2(mode: mode),
      ),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 14),
          textStyle: MmtText.button(mode: mode).copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: MmtText.bodySm(
          mode: mode,
          color: MmtColors.textFaint,
        ),
        labelStyle: MmtText.caption(mode: mode),
        errorStyle: MmtText.caption(
          mode: mode,
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        elevation: 0,
        selectedLabelStyle: MmtText.caption(
          mode: mode,
  ...
  static TextTheme _textTheme(Brightness mode) {
    return TextTheme(
      displayLarge: MmtText.h1(mode: mode).copyWith(fontSize: 48),
      displayMedium: MmtText.h1(mode: mode).copyWith(fontSize: 36),
